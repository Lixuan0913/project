...
cursor.execute("INSERT INTO phones (brand,model_name, price, image_filename, storage, description) VALUES (?, ?, ?, ?, ?, ?)", ("Honor",'Honor X9 5G', 1299, "hx9.png", "128GB", "Colour: Black, Silver, Blue, Size:166.1 x 75.8 x 8.1 mm, 189g, 6.81 inches IPS LCD Display,CPU: Octa-Core CPU, Adreno 619 GPU"))
